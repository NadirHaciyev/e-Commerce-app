...
function ProductDetail() {
  ...
  const { isLoading, error, data } = useQuery(['product', productId], () => fetchProductDetail(productId));
  ...
  return (
    <Center mt={5}>
      <Box p="2">
        ...
        <Button onClick={() => addToBasket(data)} mt={2} colorScheme={findBasketItem(data) ? 'red' : 'green'}>
